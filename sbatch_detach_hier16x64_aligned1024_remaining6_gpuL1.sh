...
ENVS=(ant hopper humanoid humanoidstandup swimmer walker2d)
ENV_NAME=${ENVS[$SLURM_ARRAY_TASK_ID]}
RUN_ROOT="$ROOT/perf_runs/csf3_detach_hier16x64_aligned1024_ggn_normnone_damp003_kfalse_${ENV_NAME}_5seed_10m_gpuL1_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}"
