...
def command_for(method, python, repo, env, seed, timesteps):
    if method == "curv256_criticggn_ktrue_l2clip05":
        return [
            ...
            "--config",
            "rat_mlp_detjc_curv256_criticggn_ktrue_l2clip05_batch262144.yaml",
            "--env_name",
            env,
            "--seed",
            str(seed),
    ...
    if method == "curv256_criticggn_ktrue_actor_fvpclip05":
        ...
        python,
        "-u",
        str(repo / "train_detach_jointcritic_actor_fvp_fisherclip_curvsub.py"),
        "--config",
        "rat_mlp_detjc_curv256_criticggn_ktrue_actor_fvpclip05_batch262144.yaml",
        "--env_name",
        env,
        "--seed",
        str(seed),
